#!/bin/bash
# instragram-fl v2.0
# coded by: @INTERNET-HELP-ZONE-SHIHAB
# github.com/internet-help-zone-shihab/instagram-fl
...
printf "\e[1;31m[\e[0m\e[1;77mv2.0\e[0m\e[1;31m]\e[0m\e[1;32m github.com/internet-help-zone-shihab/instragram-fl\e[0m\n"
